                        ...
                        <div class="col s12 m12 l12">
                            <div id="Form-advance" class="card card card-default scrollspy">
                                <div class="card-content">
                                    <h4 class="card-title">Créer Une Nouveau Produit</h4>
                                    <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col m6 s12">
                                                <input id="sale_price" type="number"
                                                       class="@error('name') is-invalid @enderror" name="sale_price" step="0.01"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12">
                                                <img src="{{asset('images/products_images/default.png')}}"  class="img-thumbnail image-preview" style="width: 150px" alt="">
                                            </div>
                                        </div>
