                        ...
                        <div class="col s12 m12 l12">
                            <div id="Form-advance" class="card card card-default scrollspy">
                                <div class="card-content">
                                    <h4 class="card-title">Créer Un Nouveau Employé</h4>
                                    <form action="{{route('users.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col m6 s12">
                                                <select  class="select2 browser-default" multiple="multiple" name="role[]">
                                                    <optgroup label="rôles">@foreach($roles as $role)
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12">
                                                   <img src=""  class="img-thumbnail image-preview" style="width: 100px" alt="">
                                            </div>
                                        </div>
